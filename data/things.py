...
thingsDict = {
    ...
    "galaxy": [("yellow-star", 40, 0.8), ("red-star", 12, 0.8), ("supermassive black hole", 1, 1)],
    "supermassive black hole": [("universe", 1, 1)],
    "yellow-star": ["star (yellow)",("medieval-wet-planet", 1, 0.4),("modern-wet-planet", 1, 0.4),("lifeless wet planet", 5, 0.5),("rocky planet", 6, 0.6), ("gas giant", 6, 0.6), ("space station", 1, 0.05)],
    "red-star": ["star (red giant)", ("medieval-wet-planet", 1, 0.1),("lifeless wet planet", 5, 0.6),("rocky planet", 6, 0.7), ("gas giant", 6, 0.6)],
    ...
    "life-forest": ["forest", ("dirt", 1, 1), ("grass", 1, 1), ("forest-life", 1, 1), ("tree", 30, 0.85)],
    ...
    "plant cell": [("cell wall", 1, 1), ("membrane", 1, 1),  ("nucleus", 1, 1), ("chloroplast", 5, 0.8), ],
    ...
    "pond-life": ["life", ("protozoa", 5, 0.8), ("algae", 5, 0.8), ("pond-hydra", 5, 0.8)],
    "park-bench": ["bench", ("modern-hobo", 1, 0.2)],
    "modern-hobo": ["modernHoboName", ("modern-hobo-head", 1, 1),("torso",1,1),("leg",2,1),("arm",2,1),("modern-hobo-attire",1,0.85)],
    "modern-hobo-head": ["head", ("modern-hobo-thought",2,1)],
    "modern-hobo-thought": ["modernHoboThought"],
    "Oxygen": [Fore.LIGHTGREEN_EX+"Oxygen"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Carbon": [Fore.LIGHTGREEN_EX+"Carbon"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Phosphorus": [Fore.LIGHTGREEN_EX+"Phosphorus"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Silicon": [Fore.LIGHTGREEN_EX+"Silicon"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Iron": [Fore.LIGHTGREEN_EX+"Iron"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Nitrogen": [Fore.LIGHTGREEN_EX+"Nitrogen"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Gold": [Fore.LIGHTGREEN_EX+"Gold"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Hydrogen": [Fore.LIGHTGREEN_EX+"Hydrogen"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
    "Helium": [Fore.LIGHTGREEN_EX+"Helium"+Fore.WHITE, ("Proton", 1, 1), ("Neutron", 1, 1), ("Electron", 1, 1)],
